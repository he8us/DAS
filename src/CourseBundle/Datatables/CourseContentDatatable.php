...
/**
 * Class CourseContentDatatable
 *
 * @package CourseBundle\Datatables
 */
class CourseContentDatatable extends AbstractDatatableView
{
    /**
     * {@inheritdoc}
     */
    public function buildDatatable(array $options = [])
    {
        ...
        $this->ajax->set([
            'url'      => $this->router->generate('course_content_results'),
            'type'     => 'GET',
            'pipeline' => 0,
        ]);
    ...
    {
        return 'CourseBundle\Entity\CourseContent';
    }
